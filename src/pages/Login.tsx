      ...
      <div className="w-full max-w-md px-4">
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Sign in to manage your subscriptions</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
