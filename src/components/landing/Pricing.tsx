...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="py-16 sm:py-24 lg:py-32 bg-white dark:bg-black overflow-hidden">
      <div ref={ref} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm dark:border-white/10 dark:bg-white/5">
          ...
          <h2 className="mt-4 sm:mt-6 text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 dark:text-white">
            ...
            <span className="sm:ml-2 text-gray-400 dark:text-white0">no catch</span>
          </h2>
          <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-500 dark:text-white/50">
        ...
        >
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border-2 border-emerald-500 bg-white p-6 sm:p-8 shadow-xl sm:shadow-2xl dark:border-emerald-400 dark:bg-white/5">
            {/* Free badge */}
            ...
            <div className="text-center">
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-white/50">Open Source</p>
            ...
            {/* Features */}
            <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-200 dark:border-white/10">
              ...
              <ul className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <span className="text-xs sm:text-sm text-gray-600 dark:text-white/50">{feature}</span>
                  </li>
                ))}
              </ul>
            </div>
