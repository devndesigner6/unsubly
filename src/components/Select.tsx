...
const selectTriggerStyles = [
  cx(
    ...
    // placeholder
    "data-[placeholder]:text-gray-500 data-[placeholder]:dark:text-white0",
    // background color
    "bg-white dark:bg-black",
    // hover
    "hover:bg-gray-50 hover:dark:bg-black/50",
    // disabled
    "data-[disabled]:bg-gray-100 data-[disabled]:text-gray-400",
    "data-[disabled]:dark:border-white/15 data-[disabled]:dark:bg-white/10 data-[disabled]:dark:text-white0",
    focusInput,
    // invalid (optional)
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine
          className={cx(
            ...
            // disabled
            "group-data-[disabled]/trigger:text-gray-300 group-data-[disabled]/trigger:dark:text-white/40",
          )}
        />
  ...
  return (
    ...
    >
      ...
      <SelectPrimitives.ItemIndicator>
        <RiCheckLine
          className="size-5 shrink-0 text-gray-800 dark:text-white/80"
          aria-hidden="true"
        />
      </SelectPrimitives.ItemIndicator>
    </SelectPrimitives.Item>
