...
const inputStyles = tv({
  base: [
    ...
    "disabled:dark:border-white/15 disabled:dark:bg-white/10 disabled:dark:text-white0",
    // file
    [
      ...
      "file:border-solid file:border-gray-300 file:bg-gray-50 file:text-gray-500 file:hover:bg-gray-100 file:dark:border-white/10 file:dark:bg-black file:hover:dark:bg-white/5 file:disabled:dark:border-white/15",
      "file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]",
      "file:disabled:bg-gray-100 file:disabled:text-gray-500 file:disabled:dark:bg-white/10",
    ],
    // focus
    focusInput,
    // invalid (optional)
          ...
          >
            <button
              ...
              className={cx(
                ...
                "text-gray-400 dark:text-white/40",
                // hover
                "hover:text-gray-500 hover:dark:text-white0",
                focusRing,
              )}
              type="button"
              onClick={() => {
